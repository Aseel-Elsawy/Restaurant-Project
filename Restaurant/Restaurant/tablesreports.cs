...
{
    public partial class tablesreports : Form
    {
        public tablesreports()
        {
            InitializeComponent();
            bindgrid();
            bindcombo();
        ...
        void bindgrid()
        {
            ...
            dt = RetrieveData.executequery("sp_tables_reports", CommandType.StoredProcedure);
        ...
        #endregion
        private void tablesreports_Load(object sender, EventArgs e)
        {
        ...
        private void searchcombo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (labelid.Text != "0")
                {
                    ...
                    DataTable dt = new DataTable();
                    dt = RetrieveData.executequery("sp_tables_reports_byitemid", CommandType.StoredProcedure,
